			...
			if (res.count > 0) {
				...
				*/
				...
				for (var i = 0; i < markersData.length; i++) {
					...
					info.id = i
					//info.iconPath='../images/markers/map-marker'+(i+1)+'.png'
...
function showMarkerDetail(that) {
	...
	for (var i = 0; i < markersData.length; i++) {
		if (markerId == i) {
			...
			that.setData({
				//["markers["+i+"].iconPath"]:'../images/markers/map-marker-cu'+(i+1)+'.png', 
				["markers[" + i + "].iconPath"]: '../images/map-marker-cu.png',
			...
			that.setData({
				//["markers["+i+"].iconPath"]:'../images/markers/map-marker'+(i+1)+'.png', 
				["markers[" + i + "].iconPath"]: '../images/map-marker.png',
			})
		}
	}
	that.setData({
